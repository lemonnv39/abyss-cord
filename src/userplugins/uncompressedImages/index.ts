...
// Discord serves <img> thumbnails through media.discordapp.net at a reduced
// size/quality. Attachment URLs (not emoji/sticker/CDN assets) can be
// redirected to cdn.discordapp.com instead, which returns the original file.
...
export default definePlugin({
    ...
    description: "Loads full-resolution images directly from Discord's CDN instead of the compressed low-res thumbnails media.discordapp.net serves.",
    ...
    start() {
        ...
        if (origSrcDesc && typeof origSrcDesc.set === "function") {
            Object.defineProperty(imgProto, "src", {
                ...
                enumerable: true,
                get() {
                    if (this.dataset && this.dataset.abyssUncompressedCdn) {
                        return this.dataset.abyssUncompressedCdn;
                    }
                ...
                set(val: string) {
                    try {
                        ...
                        urlCache.set(s, transformed);
                        if (this.dataset) {
                            this.dataset.abyssUncompressedCdn = transformed;
                        }
