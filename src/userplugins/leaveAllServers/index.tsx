...
import { Forms, GuildStore, IconUtils, Menu, RestAPI, showToast, Toasts, useEffect, useMemo, UserStore, useState } from "@webpack/common";
...
// webpack-internal action.
function leaveGuild(id: string): Promise<any> {
    return RestAPI.del({ url: `/users/@me/guilds/${id}` });
}
...
export default definePlugin({
    ...
    description: "Leave multiple servers at once, from a searchable checklist. Accessible via right-click on a server.",
