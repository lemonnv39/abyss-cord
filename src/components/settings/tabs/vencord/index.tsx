...
function Switches() {
    ...
    const Switches = [
        ...
        !IS_WEB && {
            ...
            description: "Enables GPU rasterization and zero-copy rendering for smoother scrolling and a snappier UI. Recommended.",
            restartRequired: true,
        },
        !IS_WEB && {
            key: "maxPerformance",
        ...
        !IS_WEB && {
            ...
            description: "Let Discord idle down normally when minimized or unfocused instead of running at full speed in the background. Lowers CPU/RAM usage while the window isn't visible, at the cost of calls/notifications possibly lagging slightly while minimized.",
            restartRequired: true,
        },
