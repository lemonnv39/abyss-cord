...
function EquicordIcon() {
    return <img src="https://equicord.org/assets/favicon.png" alt="Abyss" style={ICON_STYLE} />;
}
...
const cloudBackendOptions = [
    { label: "Abyss Cloud", value: "https://cloud.equicord.org/" },
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom16}>
                Abyss's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                We use our own <Link href="https://github.com/Abyss/Equicloud">Equicloud backend</Link> with enhanced features.
            ...
            <Paragraph className={Margins.bottom16}>
                Choose which cloud backend to use for storing your settings. You can switch between Abyss's and Vencord's cloud services, or use a self-hosted instance.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Synchronize your Abyss settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.
            </Paragraph>
