...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Abyss settings section",
        options: [
...
export default definePlugin({
    ...
    getInfoRows() {
        ...
        const rows = [`Abyss ${gitHashShort}${getVersionInfo()} (Equicord)`];
