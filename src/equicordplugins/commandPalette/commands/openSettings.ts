...
export const DISCORD_SETTINGS_ROUTES: SettingsRoute[] = [
    ...
    { route: "equicord_main", label: "Abyss", keywords: ["vencord"] },
    { route: "equicord_plugins", label: "Abyss Plugins", keywords: ["plugins"] },
    { route: "equicord_themes", label: "Abyss Themes", keywords: ["themes", "css"] },
    { route: "equicord_updater", label: "Abyss Updater", keywords: ["update"] },
    { route: "equicord_changelog", label: "Abyss Changelog", keywords: ["changelog", "news"] }
];
