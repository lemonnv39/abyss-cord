...
export const actions: ButtonAction[] = [
    { id: "openEquicordSettings", label: "Open Abyss tab", callback: async () => await SettingsRouter.openUserSettings("equicord_main_panel"), registrar: "Abyss" },
    { id: "openPluginSettings", label: "Open Plugin tab", callback: () => SettingsRouter.openUserSettings("equicord_plugins_panel"), registrar: "Abyss" },
    { id: "openThemesSettings", label: "Open Themes tab", callback: () => SettingsRouter.openUserSettings("equicord_themes_panel"), registrar: "Abyss" },
    { id: "openUpdaterSettings", label: "Open Updater tab", callback: () => SettingsRouter.openUserSettings("equicord_updater_panel"), registrar: "Abyss" },
    { id: "openEquicordCloudSettings", label: "Open Cloud tab", callback: () => SettingsRouter.openUserSettings("equicord_cloud_panel"), registrar: "Abyss" },
    { id: "openBackupSettings", label: "Open Backup & Restore tab", callback: () => SettingsRouter.openUserSettings("equicord_backup_restore_panel"), registrar: "Abyss" },
    { id: "restartClient", label: "Restart Client", callback: () => relaunch(), registrar: "Abyss" },
    { id: "openQuickCSSFile", label: "Open Quick CSS File", callback: () => VencordNative.quickCss.openEditor(), registrar: "Abyss" },
    { id: "openSettingsFolder", label: "Open Settings Folder", callback: async () => showItemInFolder(await VencordNative.settings.getSettingsDir()), registrar: "Abyss" },
    { id: "openInGithub", label: "Open in Github", callback: async () => VencordNative.native.openExternal(await getRepo()), registrar: "Abyss" },
        ...
        id: "checkForUpdates", label: "Check for Updates", callback: async () => {
            ...
            if (isOutdated) {
                setTimeout(() => showNotification({
                    title: "A Abyss update is available!",
