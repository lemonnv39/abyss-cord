...
export const settings = definePluginSettings({
    format: {
        ...
        default: "{equicordIcon} Abyss {equicordVersion} ({equicordHash})",
        restartNeeded: true
    }
});
...
export const settingVariables = [
    ...
    "",
    "Abyss Variables:",
    "{equicordIcon} - Abyss icon",
    "{equicordVersion} - Version of Abyss (e.g. 1.0.0)",
    "{equicordHash} - Abyss build hash (e.g. 123456789)",
    "{equicordPlatform} - Platform Abyss is running on (e.g. Dev Build)",
    "",
